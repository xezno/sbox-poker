...
public class ClothingContainer
{
	...
	public void DressEntity( AnimatedEntity citizen, bool hideInFirstPerson = true, bool castShadowsInFirstPerson = true )
	{
		...
		foreach ( var c in Clothing )
		{
			...
			var isHeadPiece = (c.Category == Sandbox.Clothing.ClothingCategory.Hair ||
				c.Category == Sandbox.Clothing.ClothingCategory.Hat ||
				c.Category == Sandbox.Clothing.ClothingCategory.Facial);
			anim.EnableHideInFirstPerson = isHeadPiece;
			anim.EnableShadowInFirstPerson = isHeadPiece;
